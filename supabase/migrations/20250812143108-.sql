...
-- Improve OTP configuration for better security
UPDATE auth.config 
SET otp_expiry_duration = 600 -- 10 minutes instead of default 1 hour
WHERE true;

-- Add index for better performance on the email lookups
