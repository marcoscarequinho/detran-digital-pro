...
const HeroSection = () => {
  ...
  return (
    <section id="inicio" className="relative min-h-screen pt-20 flex items-center bg-gradient-hero">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-4">
              ...
              <p className="text-xs lg:text-base text-white/80">
                Credenciado ao DETRAN RJ • ES • MG • SP
              </p>
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-4 md:mb-6 text-primary-foreground leading-tight">
              Transferência de Veículos
              <span className="text-gradient block">100% Digital</span>
            </h1>

            <p className="text-lg md:text-xl lg:text-2xl mb-6 md:mb-8 text-primary-foreground/90 font-medium">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 md:gap-4 mb-6 md:mb-8">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 md:px-4 py-1.5 md:py-2 rounded-full">
                ...
                <span className="text-white font-medium text-sm md:text-base">Processo Seguro</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 md:px-4 py-1.5 md:py-2 rounded-full">
                <Clock className="w-4 md:w-5 h-4 md:h-5 text-white" />
                <span className="text-white font-medium text-sm md:text-base">Rápido</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 md:px-4 py-1.5 md:py-2 rounded-full">
                <CheckCircle className="w-4 md:w-5 h-4 md:h-5 text-white" />
                <span className="text-white font-medium text-sm md:text-base">Confiável</span>
              </div>
            </div>

            <div className="bg-white/15 backdrop-blur-sm p-4 md:p-6 rounded-2xl mb-6 md:mb-8 border border-white/20">
              <p className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2">
                A partir de R$ 250,00
              </p>
              <p className="text-white/80 text-sm md:text-base">
                Preço justo e transparente para seus documentos
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
              <Button
                ...
                className="text-base md:text-lg px-6 md:px-8 py-3 md:py-4 h-auto bg-success-green hover:bg-success-green/90 transition-bounce shadow-medium hover:shadow-large"
              >
              ...
              <Button
                ...
                variant="outline"
                className="text-base md:text-lg px-6 md:px-8 py-3 md:py-4 h-auto bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm transition-smooth"
              >
                Ver Serviços
              </Button>
            </div>

            <p className="text-xs md:text-sm text-white/70 mt-4 md:mt-6">
              Atendimento: Segunda a Sexta, 9:30h às 17h
            </p>
          </div>

          {/* Visual Elements */}
          <div className="relative space-y-4 md:space-y-6 mt-8 lg:mt-0">
            {/* Links Úteis DETRAN */}
            <div className="bg-white/10 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-white/20 text-center">
              <Dialog>
                <DialogTrigger asChild>
                  <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-2.5 md:py-3 text-sm md:text-base">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-white/20 text-center">
              <Button
                ...
                className="w-full mb-3 md:mb-4 bg-success-green hover:bg-success-green/90 text-white font-semibold py-2.5 md:py-3 text-sm md:text-base"
              >
            ...
            <div className="relative bg-white/10 backdrop-blur-sm p-4 md:p-8 rounded-3xl border border-white/20">
              <h3 className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6 text-center">
                Estados Atendidos
              </h3>

              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <div className="bg-white/15 p-3 md:p-4 rounded-xl text-center">
                  <span className="text-xl md:text-2xl font-bold text-white block">RJ</span>
                  <span className="text-xs md:text-sm text-white/80">Rio de Janeiro</span>
                </div>
                <div className="bg-white/15 p-3 md:p-4 rounded-xl text-center">
                  <span className="text-xl md:text-2xl font-bold text-white block">SP</span>
                  <span className="text-xs md:text-sm text-white/80">São Paulo</span>
                </div>
                <div className="bg-white/15 p-3 md:p-4 rounded-xl text-center">
                  <span className="text-xl md:text-2xl font-bold text-white block">ES</span>
                  <span className="text-xs md:text-sm text-white/80">Espírito Santo</span>
                </div>
                <div className="bg-white/15 p-3 md:p-4 rounded-xl text-center">
                  <span className="text-xl md:text-2xl font-bold text-white block">MG</span>
                  <span className="text-xs md:text-sm text-white/80">Minas Gerais</span>
                </div>
              </div>

              <div className="mt-4 md:mt-6 text-center">
                <div className="inline-flex items-center gap-2 bg-success-green/20 text-success-green px-3 md:px-4 py-1.5 md:py-2 rounded-full border border-success-green/30">
                  <CheckCircle className="w-4 h-4" />
                  <span className="font-medium text-sm md:text-base">Processo Aprovado</span>
                </div>
              </div>
            </div>
