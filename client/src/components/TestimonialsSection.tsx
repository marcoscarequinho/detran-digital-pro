    ...
    <section id="depoimentos" className="py-12 md:py-20 bg-background">
      <div className="container mx-auto px-4">
              ...
              <CardContent className="p-4 md:p-6">
                ...
                <div className="pt-3 md:pt-4 space-y-3 md:space-y-4">
                  ...
                  <div className="pt-3 md:pt-4 border-t border-border">
                    ...
                    <div className="mt-2">
                      <span className="inline-block bg-primary/10 text-primary text-[10px] md:text-xs px-2 py-1 rounded-full">
                        {testimonial.service}
                      </span>
                    </div>
                  </div>
        ...
        <div className="mt-8 md:mt-16 text-center">
          <div className="bg-gradient-primary p-6 md:p-8 rounded-2xl shadow-medium max-w-4xl mx-auto">
            <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-primary-foreground">
            ...
            <div className="grid grid-cols-3 md:grid-cols-3 gap-4 md:gap-6">
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-primary-foreground mb-1">1000+</div>
                <div className="text-primary-foreground/80 text-xs md:text-sm">Clientes Atendidos</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-primary-foreground mb-1">4.9</div>
                <div className="text-primary-foreground/80 text-xs md:text-sm">Nota Média</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-primary-foreground mb-1">98%</div>
                <div className="text-primary-foreground/80 text-xs md:text-sm">Recomendação</div>
              </div>
            </div>
          </div>
        </div>
